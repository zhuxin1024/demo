                            ...
                            <form action="/textBook/save" method="post" id="textBookForm" enctype="multipart/form-data" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'">
                                ...
                                <table class="form_h">
                                    <tr>
                                        ...
                                        <td>
                                            <input class="input-flex" type="text" value="${info.number}" name="number" id="number"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td>
                                            <input class="input-medium" type="text" value="${info.name}" name="name" id="name"/>
                                        </td>
                                    </tr>
                                    ...
                                    <th>
                                        ...
                                        <td>
                                            <input class="input-big" type="text" value="${info.author}" name="author" id="author"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="input-flex" type="text" value="${info.press}" name="press" id="press"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="input-flex" type="text" value="${info.version}" name="version" id="version"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="input-flex" type="text" value="${info.price}" name="price" id="price"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                            <label for="flex">订阅数量</label>
                                        </th>
                                        <td>
                                            <input class="input-flex" type="text" value="" name="" id=""/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th></th>
                                        <td>
                                            <input class="button" name="submit" type="submit" value="提交订单"/>
                                        </td>
                                        <td>
                                            <a value="返回" class="button" href="/textBook/index" id="back">返回</a>
                                        </td>
                                    </tr>
                                </table>
                            </form>
