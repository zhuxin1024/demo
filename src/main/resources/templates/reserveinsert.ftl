        ...
        <div id="top">
            ...
            <!--end head-->
            	...
            	<div id="bg_wrapper">
                    ...
                    <div id="main">
                        <div id="content">
                            <form action="/reserve/save" method="post" id="textBookForm" enctype="multipart/form-data" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'">
                                <!-- form_h类用于格式化水平排列的表单 -->
                                <table class="form_h">
                                    <tr>
                                        <th>
                                            <label for="name">教材编号</label>
                                        </th>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="input-medium" type="text" value="" name="" id=""/>
                                        </td>
                                    </tr>

                                    <tr>
                                    <th>
                                            <label for="author">老师</label>
                                        </th>
                                        <td>
                                            <input class="input-big" type="text" value="" name="tname" id="tname"/>
                                        </td>
                                    </tr>

                                    <tr>
                                        <th>
                                            <label for="flex">班级</label>
                                        </th>
                                        <td>
                                            <input class="input-flex" type="text" value="" name="classinfo" id="classinfo"/>
                                        </td>
                                    </tr>

                                    <tr>
                                        <th>
                                            <label for="flex">订单数</label>
                                        </th>
                                        <td>
                                            <input class="input-flex" type="text" value="" name="reserves" id="reserves"/>
                                        </td>
                                    </tr>
